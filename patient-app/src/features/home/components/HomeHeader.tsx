...
const styles = StyleSheet.create({
  ...
  logoBlock: { flex: 1, flexDirection: "row", alignItems: "center", gap: 7, paddingRight: 4 },
  logo: { width: 42, height: 54 },
  logoTextWrap: { justifyContent: "center", flexShrink: 1 },
  logoNepal: { fontSize: 13, fontWeight: "800", color: homeColors.primary, lineHeight: 15, letterSpacing: 0.4 },
  logoSociety: { fontSize: 14, fontWeight: "800", color: homeColors.navy, lineHeight: 17, letterSpacing: 0.2 },
  logoTagline: { fontSize: 8.5, fontWeight: "500", color: "#334155", lineHeight: 11, marginTop: 1 },
  ...
  avatarInitials: { fontSize: 12, fontWeight: "800", color: homeColors.primary },
  avatarDot: {
    position: "absolute",
    bottom: 1,
    right: 0,
